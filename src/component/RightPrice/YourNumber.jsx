...
const YourNumber = () => {
  ...
  return (
    <section className="YourNumber">
      ...
      {!answer && (
        <>
          <p className="rule">Dans ce mode de jeu, vous devez choisir une plage de jeu et dans cette plage choisir un nombre dans votre tête que Party_Robot devra trouver le plus rapidement possible.</p>
          ...
          {maxNumber <= minNumber && (
            <p>
              Attention le nombre maximal est inférieur ou égal au nombre
              minimal
            </p>
          )}
        </>
        ...
        <>
          {answer > 0 && (
            <div className="container_button">
              <button onClick={changeMinAndGiveAnAnswer}>
                C&apos;est plus
              </button>
              <button onClick={changeMaxAndGiveAnAnswer}>
                C&apos;est moins
              </button>
              <button
                onClick={() => {
